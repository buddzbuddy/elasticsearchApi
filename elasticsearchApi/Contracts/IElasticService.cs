...
namespace elasticsearchApi.Contracts
{
    public interface IElasticService
    {
        ...
        bool FilterESWithExclude(IDictionary<string, object> filter, IDictionary<string, object> excludeFilter, out outPersonDTO[] data, out string[] errorMessages, out long totalCount, bool fuzzy = false, int page = 1, int size = 10);
